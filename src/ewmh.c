...
{
	Atom actions[] = {
		atoms[ATOM_NET_WM_ACTION_MOVE],
		atoms[ATOM_NET_WM_ACTION_RESIZE],
		atoms[ATOM_NET_WM_ACTION_MINIMIZE],
		atoms[ATOM_NET_WM_ACTION_SHADE],
		atoms[ATOM_NET_WM_ACTION_STICK],
		atoms[ATOM_NET_WM_ACTION_MAXIMIZE_HORZ],
		atoms[ATOM_NET_WM_ACTION_MAXIMIZE_VERT],
		atoms[ATOM_NET_WM_ACTION_FULLSCREEN],
		atoms[ATOM_NET_WM_ACTION_CHANGE_DESKTOP],
		atoms[ATOM_NET_WM_ACTION_CLOSE],
	};

	XChangeProperty(dpy, w, atoms[ATOM_NET_WM_ALLOWED_ACTIONS], XA_ATOM, 32,
	                PropModeReplace, (unsigned char *)actions, (int)LENGTH(actions));
}
